...
int score_p1(const std::string& s) {
...
int solve_p1(const std::vector<std::string>& raw_input) {
	int total_score = 0;
...
int solve_p2(const std::vector<std::string>& raw_input) {
	int total_score = 0;
	for (const std::string &s : raw_input) {
		int score = 0;
		char oplay = s[0];
...
std::vector<int>day_2_output(const std::vector<std::string>& raw_input) {
	std::vector<int> ret;
